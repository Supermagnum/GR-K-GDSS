...
\begin{strip}
\centering
\captionof{table}{SOQPSK operating parameters (representative; see gr-qradiolink README).}
\small
\begin{tabular}{@{}lllll@{}}
\toprule
...
\begin{strip}
\centering
\captionof{table}{gr-linux-crypto cross-validation (summary from TEST\_RESULTS.md).}
\scriptsize
\begin{tabular}{@{}llrrr@{}}
\toprule
...
\begin{strip}
\centering
\captionof{table}{IQ file analysis outcomes (\texttt{analyse\_iq\_files.py}, 29 checks PASS).}
\scriptsize
\begin{tabular}{@{}ll@{}}
\toprule
...
\begin{strip}
\centering
\captionof{table}{gr-k-gdss pytest modules (snapshot: 37 passed, 1 skipped).}
\scriptsize
\begin{tabular}{@{}ll@{}}
\toprule
Module / test & Status \\
...
\bibitem{p372} ITU-R P.372-15, ``Radio noise,'' International Telecommunication Union, 2023.
